...
using ToDoSqlDataBaseFirst.Services;

namespace ToDoSqlDataBaseFirst
{

    /* Scaffold-DbContext "Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Marcus\Documents\ToDoSqlDataBaseFirst.mdf;Integrated Security=True;Connect Timeout=30" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -Context TodoContext -DataAnnotations*/
    class Program
    {
